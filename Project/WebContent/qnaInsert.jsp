...
<aside>
		<form method="post" class="navform" name="testForm">
          	...
          	<section class="#">
				<form action="qnaInsertOk.jsp" method="post" enctype="multipart/form-data">
                    ...
                    <div class="board_write_wrap">
                        <div class="board_write">
                            ...
                            <div class="info">
                                ...
                                <dl>
                                    <dt>비밀번호</dt>
                                    <dd><input type="password" name="pwCheck"></dd>
                                </dl>
                            </div>
                            <div class="cont">
                                <textarea name="quesCont" placeholder="내용 입력"></textarea>
                            </div>
                        </div>
                   		<p>파일1 : <input type="file" name="queFile"></p> 
                        <div class="bt_wrap">
                        	<input type="submit" value="리뷰 업로드" class="on"> 
                            <a href="qnaMain.jsp">취소</a>
                        </div>
                    </div>
                </div>
				</form> 
