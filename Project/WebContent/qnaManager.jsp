...
<%
	List<QnaVO> list = QnaDAO.qnaAll();
	pageContext.setAttribute("qnaList", list);
%>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <table>
				  ...
				  <c:forEach var="vo" items="${qnaList }">
				  	<tr>
				    	...
				    	<td>${vo.queDate }</td>
				    	<td>
				    		<input type="button" value="삭제" onclick="location.href='qnaManagerDelete.jsp?quesNum=${vo.quesNum}'">
				    	</td>
				  	</tr>
                <c:if test="${empty vo }">
					<tr>
						<td colspan="5">문의 정보가 없습니다.</td>
					</tr>
				</c:if>
				  </tbody>
                </c:forEach>
