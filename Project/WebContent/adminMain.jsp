...
<body>
	<%@ include file="common/adminHeader.jspf" %>
		...
		<form method="post" class="navform" name="testForm">
            ...
            <div class="container">     
            <a href="goodsManager.jsp">  
			  <img src="images/goodsManager.jpg" alt="Paris" width="150" height="150">
			</a>
			<a href="goodsInsert.jsp">
			  <img src="images/goodsInsert.jpg" alt="Paris" width="150" height="150">
			</a>
			<a href="goodsTotal.jsp">
			  <img src="images/goodsTotal.jpg" alt="Paris" width="150" height="150">
			</a>
			<a href="userManager.jsp">
			  <img src="images/userManager.jpg" alt="Paris" width="150" height="150">
			</a>
			<a href="reviewManager.jsp">
			  <img src="images/reviewManager.jpg" alt="Paris" width="150" height="150">
			</a>
			<a href="qnaManager.jsp">
			  <img src="images/qnaManager.jpg" alt="Paris" width="150" height="150">
			</a>
			</div>	
            </main>
