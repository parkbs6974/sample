		...
		<form method="post" class="navform" name="testForm">
                    ...
                    <div class="board_wrap">
                        ...
                        <div class="board_view_wrap">
                            <div class="board_view">
                                ...
                                <div class="file">
                                   <td>
                              <c:if test="${empty qvo.queFile }">첨부파일: </c:if>
                            ...
                            <div class="bt_wrap">
                                <a href="qnaMain.jsp" class="on">목록</a>
                                <a href="qnaUpdate.jsp" onclick="update_go(this.form)">수정</a>
               ...
               <div class="comment">
                  <form action="CommDelete.jsp" method="get">
                     관리자 답변 :${CommentsVO.commCont } <br>   
                     작성 시간: ${CommentsVO.commDate } 
                  </form>
               </div>
               </c:forEach>
                </section>
