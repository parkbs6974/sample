...
<form id="accesspanel" action="aLoginck.jsp" method="post">
  <h1 id="litheader">관리자 로그인</h1>
  <div class="inset">
    <p>
      <input type="text" name="id" id="email" placeholder="Email address">
    </p>
    <p>
      <input type="password" name="passwd" id="password" placeholder="Access code">
    </p>
    </div>
  <p class="p-container">
    <input type="submit" name="Login" id="go" value="전송">
  </p>
</form>
</body>
</html>
